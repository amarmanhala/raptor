...
"use strict";
if($("#waitingDCFMReviewQuotesCtrl").length) {
    app.controller('waitingDCFMReviewQuotesCtrl', [
...
//                    },
        ...
        $scope.gridWaitingDCFMReview.multiSelect = false;
        ...
        $scope.exportToExcel=function(){
            ...
            window.open(base_url+'quotes/exportexcel/waitingdcfmreview?'+$.param($scope.filterOptions));
        ...
        var getPage = function() {
            ...
            $('#waitingDCFMReviewQuotesCtrl .overlay').show();
            $http.get(base_url+'quotes/loadwaitingdcfmreviewquotes?'+ qstring ).success(function (data) {
                $('#waitingDCFMReviewQuotesCtrl .overlay').hide();

...
"use strict";
if($("#inprogressQuotesCtrl").length) {
    app.controller('inprogressQuotesCtrl', [
...
//                    },
        ...
        $scope.exportToExcel=function(){
            ...
            window.open(base_url+'quotes/exportexcel/inprogress?'+$.param($scope.filterOptions));
        ...
        var getPage = function() {
            ...
            $('#inprogressQuotesCtrl .overlay').show();
            $http.get(base_url+'quotes/loadinprogressquotes?'+ qstring ).success(function (data) {
                $('#inprogressQuotesCtrl .overlay').hide();

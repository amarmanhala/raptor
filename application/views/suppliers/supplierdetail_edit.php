<div class= "row">
    <div class= "col-md-12">
        <form name = "supplierdetailform" id = "supplierdetailform" action ="" class= "form-horizontal" method = "post">
            ...
            <div class= "box">
                ...
                <div class= "box-body">
                    <div class= "form-group <?php if (form_error('companyname')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-8">
                            <input type = "text" class= "form-control" id = "companyname" name = "companyname" placeholder= "Company Name" value = "<?php echo set_value('companyname', $supplier['companyname']);?>" required = "required" />
                    ...
                    <div class= "form-group">
                        ...
                        <div class= "col-sm-2 <?php if (form_error('structure')) echo ' has-error';?>">
                            <select id = "structure" name = "structure" class= "form-control" required = "required" >
                                ...
                                <option value = "Company" <?php if (strtolower(set_value('structure', $supplier['structure'])) == 'company') echo "selected";?>>Company</option>
                                <option value = "Sole Trader" <?php if (strtolower(set_value('structure', $supplier['structure'])) == 'sole trader') echo "selected";?>>Sole Trader</option>
                                <option value = "Partnership" <?php if (strtolower(set_value('structure', $supplier['structure'])) == 'partnership') echo "selected";?>>Partnership</option>
                            </select>
                        ...
                        <div class= "col-sm-2 <?php if (form_error('abn')) echo ' has-error';?>">
                            <input type = "text" class= "form-control" id = "abn" name = "abn" value = "<?php echo set_value('abn', $supplier['abn']);?>" data-inputmask= '"mask": "99 999 999 999"' data-mask />
                            <?php echo form_error('abn', '<span class= "help-block with-errors" for= "abn" generated = "TRUE">', '</span>'); ?>
                        </div>
                        <div class="col-sm-3 checkbox">
                            <label class="">
                                <input type="checkbox"  id="isgstregistered" name="isgstregistered" value="1" <?php if(set_value('isgstregistered', $supplier['isgstregistered']) == "1") echo "checked";?> />GST Registered</label>
                        </div>
                    </div>
                    <div class= "form-group <?php if (form_error('typeid')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-10">
                            ...
                            foreach ($suppliertypes as $key => $value) { ?>
                                <label class="radio-inline"><input type="radio" value="<?php echo $value['id']; ?>" data-code="<?php echo $value['code']; ?>" name="typeid" <?php if(set_value('typeid', $supplier['typeid']) == $value['id']){ echo "checked"; $code = $value['code'];} ?> ><?php echo $value['name'];?></label>
                            <?php } ?>
                        ...
                        <div class= "col-sm-5">
                            <select name = "tradeid" id = "tradeid" class= "form-control">
                                ...
                                <?php foreach ($se_trades as $key => $value) { ?>
                                      <option value = "<?php echo $value['id'];?>" <?php if (set_value('tradeid', $supplier['tradeid']) == $value['id']) echo "selected";?> ><?php echo $value['se_trade_name'];?></option> 
                                <?php } ?>
                            </select>
                            <input type="hidden" name="primarytrade" id="primarytrade" value="<?php echo set_value('primarytrade', $supplier['primarytrade']); ?>"/>
            ...
            <div class= "box">
                ...
                <div class= "box-body">
                    <div class= "form-group <?php if (form_error('shipping1')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-8">
                            <input type = "text" class= "form-control" id = "shipping1" name = "shipping1" placeholder= "Address1" value = "<?php echo set_value('shipping1', $supplier['shipping1']);?>" required = "required" />
                    ...
                    <div class= "form-group <?php if (form_error('shipping2')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-8">
                            <input type = "text" class= "form-control" id = "shipping2" name = "shipping2" placeholder= "Address2" value = "<?php echo set_value('shipping2', $supplier['shipping2']);?>" />
                    ...
                    <div class= "form-group ">
                        ...
                        <div class= "col-sm-2 <?php if (form_error('shipsuburb')) echo ' has-error';?>">
                            <input type = "text" class= "form-control suburbtypeahead" data-suburb= "shipsuburb1"   data-state = "shipstate" data-postcode = "shippostcode" id = "shipsuburb" name = "shipsuburb" placeholder= "search.."  value = "<?php echo set_value('shipsuburb', $supplier['shipsuburb']);?>" required = "required" />
                            <input type = "hidden" class= "updatesuburb" data-suburb= "shipsuburb"   id = "shipsuburb1" name = "shipsuburb1"   value = "<?php echo set_value('shipsuburb1', $supplier['shipsuburb']);?>" />
                        ...
                        <div class= "col-sm-2 <?php if (form_error('shipstate')) echo ' has-error';?>">
                            <select name = "shipstate" id = "shipstate" class= "form-control" required = "required" readonly="readonly"  >
                                ...
                                <?php foreach ($states as $key => $value) { ?>
                                        <option value = "<?php echo $value['abbreviation'];?>" <?php if (set_value('shipstate', $supplier['shipstate']) == $value['abbreviation']) echo "selected";?>><?php echo $value['abbreviation'];?></option> 
                                <?php } ?>
                            </select>
                        ...
                        <div class= "col-sm-2 <?php if (form_error('shippostcode')) echo ' has-error';?>">
                            <input type = "text" class= "form-control postcodetypeahead" id = "shippostcode" name = "shippostcode" placeholder= "search.." readonly="readonly"   value = "<?php echo set_value('shippostcode', $supplier['shippostcode']);?>" required = "required" />
            ...
            <div class= "box">
                ...
                <div class= "box-body">
                    <div class= "form-group <?php if (form_error('mail1')) echo ' has-error';?>">
                        <label for= "input" class= "col-sm-2 control-label">Address </label>
                        <div class= "col-sm-8">
                            <input type = "text" class= "form-control" id = "mail1" name = "mail1" placeholder= "Address1" value = "<?php echo set_value('mail1', $supplier['mail1']);?>" required = "required" />
                    ...
                    <div class= "form-group <?php if (form_error('mail2')) echo ' has-error';?>">
                        <label for= "input" class= "col-sm-2 control-label">&nbsp;</label>
                        <div class= "col-sm-8">
                            <input type = "text" class= "form-control" id = "mail2" name = "mail2" placeholder= "Address2" value = "<?php echo set_value('mail2', $supplier['mail2']);?>" />
                    ...
                    <div class= "form-group ">
                        ...
                        <div class= "col-sm-2 <?php if (form_error('mailsuburb')) echo ' has-error';?>">
                            <input type = "text" class= "form-control suburbtypeahead" data-suburb= "mailsuburb1"  data-state = "state" data-postcode = "postcode" id = "mailsuburb" name = "mailsuburb" placeholder= "search.."  value = "<?php echo set_value('mailsuburb', $supplier['mailsuburb']);?>" required = "required" />
                            <input type = "hidden" class= "updatesuburb" data-suburb= "mailsuburb"   id = "mailsuburb1" name = "mailsuburb1"   value = "<?php echo set_value('mailsuburb1', $supplier['mailsuburb']);?>" />
                        ...
                        <div class= "col-sm-2 <?php if (form_error('state')) echo ' has-error';?>">
                            <select name = "state" id = "state" class= "form-control" required = "required" readonly="readonly"  >
                                <option value = ''>-Select-</option>
                             <?php foreach ($states as $key => $value) { ?>
                                    <option value = "<?php echo $value['abbreviation'];?>" <?php if (set_value('state', $supplier['state']) == $value['abbreviation']) echo "selected";?>><?php echo $value['abbreviation'];?></option> 
                            <?php } ?>
                            </select>
                        ...
                        <div class= "col-sm-2 <?php if (form_error('postcode')) echo ' has-error';?>">
                            <input type = "text" class= "form-control postcodetypeahead" id = "postcode" name = "postcode" placeholder= "search.." readonly="readonly"  value = "<?php echo set_value('postcode', $supplier['postcode']);?>" required = "required" />
                    ...
                    <div class= "form-group <?php if (form_error('country')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-4 ">
                           <input type = "text" class= "form-control" id = "country" name = "country" placeholder= "Country" value = "<?php   echo set_value('country', $supplier['country']);?>" />
            ...
            <div class= "box">
                ...
                <div class= "box-body">
                    <div class= "form-group">
                        ...
                        <div class= "col-sm-3 <?php if (form_error('phone')) echo ' has-error';?>">
                            <div class= "input-group">
                                <input type = "text" class= "form-control" id = "phone" name = "phone" placeholder="xx xxxx xxxx" value = "<?php echo set_value('phone', $supplier['phone']);?>" pattern= "[0-9]{2} [0-9]{4} [0-9]{4}" data-inputmask= '"mask": "99 9999 9999"' data-mask />
                        ...
                        <div class= "col-sm-3 <?php if (form_error('fax')) echo ' has-error';?>">
                            <div class= "input-group">
                                <input type = "text" class= "form-control" id = "fax" name = "fax" placeholder="xx xxxx xxxx" value = "<?php echo set_value('fax', $supplier['fax']);?>" pattern= "[0-9]{2} [0-9]{4} [0-9]{4}" data-inputmask= '"mask": "99 9999 9999"' data-mask />
                                <div class= "input-group-addon">
                                    <i class= "fa fa-fax"></i>
                                </div>
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('email')) echo ' has-error';?>">
                        ...
                        <div class="col-sm-3">
                            <div class= "input-group">
                                <input type = "text" class= "form-control" id = "mobile" name = "mobile" placeholder="xxxx xxx xxx" value = "<?php echo set_value('mobile', $supplier['mobile']);?>" pattern= "[0-9]{4} [0-9]{3} [0-9]{3}" data-inputmask= '"mask": "9999 999 999"' data-mask />
                                <div class= "input-group-addon">
                    ...
                    <div class= "form-group <?php if (form_error('email')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-7">
                            <div class= "input-group">
                                <input type = "email" class= "form-control" id = "email" name = "email" placeholder= "Email"    value = "<?php echo set_value('email', $supplier['email']);?>" required = "required" />
                                <div class= "input-group-addon">
                    ...
                    <div class= "form-group <?php if (form_error('url')) echo ' has-error';?>">
                        ...
                        <div class= "col-sm-7">
                            <div class= "input-group">
                                <input type = "url" class= "form-control" id = "url" name = "url"   placeholder= "http://www.yourwebsite.com"   value = "<?php echo set_value('url', $supplier['url']);?>" />
                                <div class= "input-group-addon">
                    ...
                    <div class= "form-group">
                        <label for= "input" class= "col-sm-2 control-label">&nbsp;</label>
                        <div class= "col-sm-10">
                            <input  type = "hidden" name = "supplierid" id = "supplierid" value = "<?php echo $supplier['customerid'];?>"/>

  ...
  <div class= "box">
    ...
    <div class= "box-body">
        ...
        <div class= "form-group">
                ...
                <div class= "col-sm-4">
                  <input type = "text" class= "form-control" id = "mobile" name = "mobile" value = "<?php echo set_value('mobile');?>" pattern= "[0-9]{4} [0-9]{3} [0-9]{3}" data-inputmask= '"mask": "9999 999 999"' data-mask  />
                </div>
            ...
            <div class= "form-group">
                ...
                <div class= "col-sm-4">
                  <input type = "text" class= "form-control" id = "phone" name = "phone" value = "<?php echo set_value('phone');?>" pattern= "[0-9]{2} [0-9]{4} [0-9]{4}" data-inputmask= '"mask": "99 9999 9999"' data-mask />
                </div>
        </div> 
          ...
          <div class= "form-group <?php if (form_error('email')) echo ' has-error';?>">
              ...
              <input type = "text" name = "email" class= "form-control" placeholder= "Email" value = "<?php echo set_value('email');?>" />
                <?php echo form_error('email', '<span class= "help-block error" for= "email" generated = "TRUE">', '</span>'); ?>
              </div> 
          </div>
            
            <div style="display:none;" class= "form-group <?php if (form_error('mailgroup')) echo ' has-error';?>">
               <label class= "col-sm-3 control-label">Mail Group</label>
              <div class= "col-sm-5"> 
                    <select id = "mailgroup" name = "mailgroup[]" class= "form-control selectpicker" multiple data-live-search= "TRUE" title = "Mail Group" data-size = "auto" data-width= "100%">
                        <?php 
                        $mailgroup = set_value('mailgroup[]');
                        foreach ($mailgroups as $key => $value) {
                                $selected = '';
                                if (is_array($mailgroup) && in_array($value['id'], $mailgroup)) {
                                    $selected = ' selected';
                                }         
                            ?>
           ...
           <div class= "form-group">
                ...
                <div class= "col-sm-7">
                  <input type = "text" class= "form-control" id = "street1" name = "street1" placeholder= "Address1" value = "<?php echo set_value('street1');?>" />
                </div>
        </div>
        <div class= "form-group">
                <label class= "col-sm-3 control-label">&nbsp;</label>
                <div class= "col-sm-7">
                  <input type = "text" class= "form-control" id = "street2" name = "street2" placeholder= "Address2" value = "<?php echo set_value('street2');?>" />
                </div>
        </div>
        <div class= "form-group">
                <label class= "col-sm-3 control-label">Suburb/State/Post Code</label>
                <div class= "col-sm-3">
                      <input type = "text" class= "form-control  suburbtypeahead" data-suburb= "suburb1"  data-state = "state" data-postcode = "postcode" id = "suburb" name = "suburb" placeholder= "search.."  value = "<?php echo set_value('suburb1');?>" />
                ...
                <div class= "col-sm-2">
                  <input type = "text" class= "form-control postcodetypeahead" id = "postcode" name = "postcode" placeholder= "search.." value = "<?php echo set_value('postcode');?>" />
                </div>
                
        </div>
        <div class= "form-group">
                <label class= "col-sm-3 control-label">Territory</label>
                <div class= "col-sm-4">
                    <input type = "text" class= "form-control" id = "territory" name = "territory" readonly = "readonly" value = "<?php echo set_value('territory');?>" />
                </div>
        </div> 
                    ...
                    <select name = "bossid" id = "bossid" class= "form-control">
                                    <option value = ''>-Select-</option>
                                     <?php foreach ($reportstocontacts as $key => $value) {
                                         $selected = '';
                                         if ($value['contactid'] == set_value('bossid')) {
                                             $selected = " selected";
                                         }
                                    ?>
             ...
             <!-- Profile Image -->
              <div class= "box box-primary">
                <div class= "box-body box-profile">
                    <img class= "profile-user-img img-responsive img-circle" id = "selected-profile" src= "<?php  echo base_url("assets/img/user2-160x160.jpg"); ?>" alt = "User Image" />
        ...
        <input type = "hidden" name = "editcontact" id = "editcontact" value = '' />
        </form>
    </div><!-- /.box-body -->

      ...
      foreach ($menu as $key => $value) {
            ...
            if (count($value['child'])== 0) {
                ...
                if($value['text_color'] != '' || $value['text_color'] != NULL) {
                 ...
                 ?>            
      <li <?php echo $active;?>>
                        <a onmouseover="this.style.color='<?php echo $scriptTextColor;?>';this.style.background='<?php echo $scriptBackground;?>';this.style.borderLeftColor='<?php echo $scriptBorderLeft;?>';" <?php if($active == '') { echo 'onmouseout="this.removeAttribute(\'style\');"';}?> <?php echo $barcolor;?> href="<?php echo site_url($url); ?>" title ="<?php echo $value['name'];?>" target ="<?php echo $value['target'];?>">
              ...
              <?php 
                ...
                <li class="treeview <?php  echo $active;?>">
                    <a href="#" onmouseover="this.style.color='<?php echo $scriptTextColor;?>';this.style.background='<?php echo $scriptBackground;?>';this.style.borderLeftColor='<?php echo $scriptBorderLeft;?>';" <?php if($active == '') { echo 'onmouseout="this.removeAttribute(\'style\');"';}?> <?php echo $barcolor;?> title ="<?php echo $value['name'];?>">
                        <?php if($value['menu_icontype'] == 'ICON' || $value['menu_image'] == '' || $value['menu_image'] == NULL ){?>
                            <i class="<?php echo $value['menu_icon'];?>"></i>
                        <?php } else {?>
                            <i class="menu-i-image ion"><img src="<?php echo base_url();?>assets/img/<?php echo $value['menu_image'];?>" class="menuicon-image"></i>
                    ...
                    <ul class="treeview-menu">
                      <?php foreach ($value['child'] as $key2=> $value2) {  
                            ...
                            if($value2['bar_color'] != '' || $value2['bar_color'] != NULL) {
                                $barcolorValue = $value2['bar_color'];
                                $textcolor = $value2['text_color'];
                          ...
                          ?>   
                        <li <?php  echo $active;?>>
                            <a href="<?php echo site_url($url);?>" onmouseover="this.style.color='<?php echo $scriptTextColor;?>';this.style.background='<?php echo $scriptBackground;?>';this.style.borderLeftColor='<?php echo $scriptBorderLeft;?>';" <?php if($active == '') { echo 'onmouseout="this.removeAttribute(\'style\');"';}?> <?php echo $barcolor;?> title ="<?php echo $value2['name'];?>" target ="<?php echo $value2['target'];?>">

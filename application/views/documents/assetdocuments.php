<!-- Default box -->
<div  id = "AssetDocumentCtrl" ng-app="app" ng-controller= "AssetDocumentCtrl">
    <div class= "box" >
        <div class="box-header with-border">
            <h3 class="box-title text-blue">Asset Document Library</h3>
                ...
                <div class="row">
                    <div class= "col-sm-4 col-md-2" style="padding-right: 5px;">
                        ...
                        <?php foreach ($docType as $key => $value) {
                                echo '<option value="'.$value['doctype'].'">'.$value['doctype'].'</option>';
                            }?>
                        </select>
                    </div>
                    ...
                    <div class= "col-sm-4 col-md-2" style="padding-right: 5px;">
                        ...
                        <select class= "form-control selectpicker"   multiple data-live-search= "TRUE" title = "All" data-size = "auto" data-width= "100%"   ng-change = "changeFilters()" ng-model= "filterOptions.category">
                        <?php foreach ($assetCategory as $key => $value) {

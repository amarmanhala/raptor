<div class="row" id="WaitingWOApprovalHistoryCtrl" ng-controller="WaitingWOApprovalHistoryCtrl">
    <div class="col-md-12">
        <div class="box">
            <div class="box-header  with-border">
                <h3 class="box-title text-blue">Approval History</h3>
            ...
            <div class= "box-header  with-border"> 
                <div class="row form-horizontal">
                    <div class= "col-sm-4 col-md-2 col-md-offset-5" > 
                        ...
                        <?php foreach($waitingwoapprovalhistoryJobSuburb as $key=>$value) {  ?>
            ...
            <div class="box-body">
                <div id="WaitingWOApprovalHistoryjobstbl">
                    <div ui-grid = "gridWaitingWOApprovalHistory" ui-grid-pagination ui-grid-auto-resize ui-grid-resize-columns class= "grid"></div>
                </div>
            </div>

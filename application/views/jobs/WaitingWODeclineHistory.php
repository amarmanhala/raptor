<div class="row" id="WaitingWODeclineHistoryCtrl" ng-controller="WaitingWODeclineHistoryCtrl">
    <div class="col-md-12">
        <div class="box">
            <div class="box-header  with-border">
                <h3 class="box-title text-blue">Decline History</h3>
            ...
            <div class= "box-header  with-border"> 
                <div class="row form-horizontal">
                    <div class= "col-sm-4 col-md-2 col-md-offset-5" > 
                        ...
                        <?php foreach($waitingwodeclinehistorySuburb as $key=>$value) {  ?>
            ...
            <div class="box-body">
                <div id="WaitingWODeclineHistoryJobstbl">
                    <div ui-grid = "gridWaitingWODeclineHistory" ui-grid-pagination ui-grid-auto-resize ui-grid-resize-columns class= "grid"></div>
                </div>
            </div>

<div class="row" id="completedJobsCtrl" ng-controller="completedJobsCtrl">
    <div class="col-md-12">
        <div class="box">
            <div class="box-header  with-border">
                <h3 class="box-title text-blue">Completed Jobs</h3>
            ...
            <div class= "box-header  with-border"> 
                <div class="row form-horizontal">
                    ...
                    <div class= "col-sm-4 col-md-2" > 
                        ...
                        <?php foreach($completedJobSuburb as $key=>$value) {  ?>
                ...
                <div class="row form-horizontal" style="margin-top: 10px;">
                    ...
                    <div class="input-group input-group-sm">
                        <select id="c_glcode" name="c_glcode" class="form-control">
                        ...
                        <span class="input-group-btn">
                            <button type="submit" id="c_updateglcode" class="btn btn-default btn-flat" data-loading-text ="Saving...">Update</button>
                        </span>
                    </div>
                    </div>
                </div>
            ...
            <div class="box-body">
                <div id="completedjobstbl">
                    <div ui-grid = "gridCompleted" ui-grid-pagination ui-grid-auto-resize ui-grid-resize-columns ui-grid-selection class= "gridwithselect1"></div>
                </div>
            </div>

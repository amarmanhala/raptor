...
<div class="box" ng-app = "app" id="portalSetupCtrl"  ng-controller="portalSetupCtrl">
    ...
    <div class="box-body nav-tabs-custom" id="portalsettings">
        ...
        <div class="tab-content" >
            <div role="tabpanel" class="tab-pane active" id="securedfunctions">
                <?php $this->load->view('admin/portalsettings');?>
            </div>
            <div role="tabpanel" class="tab-pane" id="auditlog">
                <?php $this->load->view('admin/portalauditlog');?>
            </div>
        </div>
    </div><!-- /.box-body -->
</div><!-- /.box -->
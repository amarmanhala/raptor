            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-md-8">
                    ...
                    <div class="input-group input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Gl Code/Description" ng-change="changeText()" ng-model="filterOptions.filterText" id="filterText" name="filterText" aria-invalid="false">
...
<?php   if($this->session->userdata('raptor_role') != 'site contact') { ?>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="exampleModalLabel">Add Budget By GL Code</h4> 
      </div>
      ...
      <div class="modal-body">
            ...
            <div id="sitegriddiv"> 
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="input" class="col-sm-3 control-label">Gl Code </label>
                    <div class="col-sm-9">
                        <select id="siteid" name="siteid" class="form-control select2" data-placeholder="Select an Gl Code" required >
                            <option value="">-Select-</option>
                            <?php /*if($this->session->userdata('raptor_role') == 'master') { ?>  
                                <option value="0">All Gl Code</option>
...
<?php  }  ?>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
        ...
        <form name="importbudget_form" id="importbudget_form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo site_url('budgets/importbudgetexcelbyglcode') ?>" >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

 ...
 */
$config['site_title']                 = "DCFM Client Portal";       // Site Title, example.com
$config['admin_email']                = "itglobal1@dcfm.com.au";   // Admin Email, admin@example.com
